...
public class World extends JComponent implements ModelDisplay
{
   ...
   */
  /* Changed */
  public synchronized Turtle getLastTurtle()
  {
   ...
   */
  /* Changed */
  public synchronized void addModel(Object model)
  {
   ...
   */
  /* Changed */
  public synchronized boolean containsTurtle(Turtle turtle)
  {
   ...
   */
  /* Changed */
  public synchronized void remove(Object model)
  {
...
//  }
   ...
   */
  /* Changed */
  public synchronized List getTurtleList() 
  { return turtleList;}
   ...
   */
  /* Change */
  public synchronized Iterator getTurtleIterator()
